...
4. What do we need in order to have a _many to many_ relationship between two tables.
   To model this relationship, we need to introduce an intermediary table that holds foreign keys that reference the primary key on the related
